...
const User = class {
    ...
    /**
     * Get the enrollmentSecret.
     * @returns {string} The enrollmentSecret.
     */
	getEnrollmentSecret() {
    ...
    /**
     * Set the enrollmentSecret.
     * @param {string} The enrollmentSecret.
     */
	setEnrollmentSecret(enrollmentSecret) {
